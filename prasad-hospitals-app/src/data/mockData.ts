...
export const branches: Branch[] = [
  {
    ...
    address: '44-617/12, behind Telephone Exchange, IDA, Nacharam, Secunderabad – 500076',
    phone: '+91-40-2304-5678',
    googleMapsReviewUrl: 'https://search.google.com/local/writereview?placeid=ChIJvdSxUfubyzsRr_MCzZRJFPo',
  },
  {
    id: 'pragathi-nagar',
    name: 'Prasad Hospitals Pragathi Nagar',
    area: 'Pragathi Nagar, Hyderabad',
    address: 'Pragathi Nagar Rd, opp. Nexa Service, Kukatpally, Hyderabad – 500085',
  ...
  },
  {
    ...
    address: 'Marrichettu Road, opp. Paradise, Manikonda, Hyderabad – 500089',
    phone: '+91-40-6674-5678',
    googleMapsReviewUrl: 'https://search.google.com/local/writereview?placeid=ChIJywbK1beXyzsRufKDa-0S-1U',
  },
]
